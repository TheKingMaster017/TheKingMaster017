...
Soy un Estudiante de Ingeniería en Sistemas y Profesorado en TIC, apasionado por resolver problemas técnicos y construir soluciones digitales eficientes. Mi enfoque actual combina el Soporte IT Avanzado con el desarrollo de software Frontend.

En lo que estoy enfocado:

* HTML5, CSS3, JavaScript y lógica de programación sólida.
* Soporte técnico de hardware/software, redes y optimización de sistemas.
* Creación de bots (Discord) y mejora de flujos de trabajo.
* Transmitir conocimientos técnicos de forma clara y pedagógica.
...
"El desarrollo de software no es solo escribir código, es resolver problemas para el futuro."
